...
main(){
    ...
    if [ "CREPE" = $pitch_est ]; then
        ...
        local -r melody_analyze_dst="./resources/$song_name/analyzed/melody/crepe/manalyze.json"
    ...
    if [ "pYIN" = $pitch_est ]; then
        ...
        local -r post_pyin_dst="./resources/$song_name/analyzed/melody/pyin/vocals.json"
        ...
        local -r melody_analyze_chord_src="$chord_to_roman_dst"
        local -r melody_analyze_dst="./resources/$song_name/analyzed/melody/pyin/manalyze.json"
        detectFile "$melody_analyze_melody_src"
        detectFile "$melody_analyze_chord_src"
