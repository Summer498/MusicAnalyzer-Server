...
export class ChordNotesInOctave extends MVVM_Collection<ChordNoteVM> {
...
export class ChordNotesSeries extends ReflectableTimeAndMVCControllerCollection<ChordNotes> {
