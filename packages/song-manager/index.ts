...
export class SongManager {
  ...
  #hierarchical_arrow?: SvgCollection[];
  ...
  get hierarchical_arrow() { return this.#hierarchical_arrow || (this.#hierarchical_arrow = getHierarchicalArrowSVGs(this.analysis_data.hierarchical_melody)); }
