...
const piano_roll = SVG.svg({ name: "piano-roll", x: 0, y: 0, width: `${piano_roll_width}px`, height: `${piano_roll_height + slide_bar_param.height}px`, }, undefined, [
    SVG.g({ name: "slide-bar", x: 0, y: 0, width: `${slide_bar_param.width}px`, height: `${slide_bar_param.height}px` }, undefined, [slide_bar, slide_button]),
